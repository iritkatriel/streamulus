...
//    struct input_stream_terminal_rule : proto::terminal<InputStream<proto::_> > {};
    ...
    // TODO: can we make one generic version
...
#undef STREAMULUS_GRAMMAR_BINARY_OPERATOR_CASE
    ...
    : proto::or_< 
        proto::when<function_0_rule, 
                    generic_func(get_termainal_value(proto::_child0), proto::_state)
        >
        , proto::when<function_1_rule, 
                    generic_func(get_termainal_value(proto::_child0), 
